...
producto2 = Producto("Camiseta de futbol", 15.99, "Ropa")
...
producto6 = Producto("Microfono", 534.99, "Tecnologia")
producto7 = Producto("Gps", 149.99, "Tecnologia")
producto8 = Producto("Adidas campus", 557.282, "Calzado")
producto9 = Producto("iphone13",699.990, "Tecnologia")
